...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:false,iconCls:'icon-save',modal:true,title:'修改密码',buttons:[{text:'确认修改',iconCls: 'icon-ok',handler:submitEdit}]" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        <table>
           <tr>
                ...
                <td><input type="text" name="username" class="wu-text easyui-validatebox" readonly="readonly" value="${login_user.username }" /></td>
            </tr>
            <tr>
   ...
   <script type="text/javascript">
		function submitEdit(){
			...
			$.ajax({
				url:'<%=request.getContextPath()%>/system/modifyPassWord',
				type:'post',
